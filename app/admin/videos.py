...
def videos():
    ...
    return render_template('admin/videos/videos.html', form=form, videos=videos.items, categories=categories,
                           next_url=next_url, prev_url=prev_url,
                           url=url_for('admin.add_video'))
...
def add_video():
    ...
    if request.method == 'POST':
        if form.validate_on_submit:
            video = Video(title=form.title.data, slug=slugify(form.title.data))
...
def edit_video(uid):
    ...
    return render_template('admin/videos/videos.html', form=form, videos=videos.items, categories=categories,
                           next_url=next_url, prev_url=prev_url,
                           url=url_for('admin.edit_video', uid=uid), video=video)
